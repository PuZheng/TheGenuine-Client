...
package com.puzheng.lejian.image_utils;
...
import com.puzheng.lejian.BuildConfig;
...
public class ImageFetcher extends ImageResizer {
    ...
    public static ImageFetcher getImageFetcher(Activity activity, int mImageThumbSize, float memCacheSizePercent) {
        ...
        ImageFetcher fetcher = new ImageFetcher(activity, mImageThumbSize);
    ...
    private void checkConnection(Context context) {
        ...
        if (networkInfo == null || !networkInfo.isConnectedOrConnecting()) {
            Toast.makeText(context, R.string.httpError, Toast.LENGTH_LONG).show();
    ...
    public boolean downloadUrlToStream(String urlString, OutputStream outputStream) {
        ...
        try {
            final URL url = HttpUtil.getURL(urlString);
